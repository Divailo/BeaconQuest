...
public class FragmentProfileFriends extends BaseFragment {

    @BindView(R.id.profile_some_list) RecyclerView leaderBoardList;

    public FragmentProfileFriends() {
    }

    public static FragmentProfileFriends newInstance(int pos) {
        FragmentProfileFriends fragmentMyProfile = new FragmentProfileFriends();
    ...
    private void setUpRecycler(){
        ArrayList<Friend> adsList = new ArrayList<>();
//        for (int i = 0; i < 10; i++){
