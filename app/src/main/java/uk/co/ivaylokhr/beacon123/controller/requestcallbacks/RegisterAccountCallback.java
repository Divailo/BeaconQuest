...
public class RegisterAccountCallback extends BaseCallback {

    JSONObject jsonObject;

    public RegisterAccountCallback(MainActivity activity) {
        super(activity);
    }
    ...
    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response){
        ...
        try {
            ...
            Log.i(errorTag, "problem v RegisterAccountCallback JSON");
        }
    ...
    public void onFailure(Call<ResponseBody> call, Throwable t) {
        Log.i(errorTag, "problem v RegisterAccountCallback");
